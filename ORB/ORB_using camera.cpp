...
int main(int argc, char * argv[]) try
{
    ...
    while (waitKey(1) < 0 && getWindowProperty(window_name, WND_PROP_AUTOSIZE) >= 0){
        ...
        Mat image;
        std::chrono::duration<double> sec3 = std::chrono::system_clock::now() - start;
...
///////////////////////////////////////////////////////////////////
        ...
        cout << "Pyramid time : "   << 1000*(sec2.count() - sec3.count())<<" ms" << endl;
